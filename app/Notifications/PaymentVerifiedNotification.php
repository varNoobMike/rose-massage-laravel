...
class PaymentVerifiedNotification extends Notification
{
    ...
    public function toArray($notifiable): array
    {
        ...
        return [
            ...
            'message' => $isClient
                ? 'Great news! Your payment of ₱' . number_format($this->payment->amount, 2) . ' has been verified successfully. Your booking is now secure.'
                : 'Payment for Booking #' . $this->booking->id . ' has been marked as verified.',
        ];
    }
}
