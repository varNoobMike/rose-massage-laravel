        ...
        <div class="collapse d-md-block" id="reportFilter">
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="Booking ID, Client, Service"
                ...
                <div class="col-12 col-md-6 d-flex gap-2">
                    ...
                    <a href="{{ route('reports.bookings') }}" class="btn btn-outline-secondary w-100">
