...
@section('page-title', 'Receptionist')

@section('breadcrumb-parent', 'Receptionist #' . $user->id)
@section('breadcrumb-parent-url', route('receptionists.show', $user->id))

@section('page-header', true)
@section('page-header-title-showpage', 'Edit Receptionist #' . $user->id)
@section('page-header-subtitle', 'Update this receptionist account')

@section('content')
    <form action="{{ route('receptionists.update', $user->id) }}" method="POST" enctype="multipart/form-data">
