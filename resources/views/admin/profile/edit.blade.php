...
@section('page-header-title-showpage', 'Edit Profile')
@section('page-header-subtitle', 'Update your profile information')
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-bottom border-light">
                                        ...
                                        <td class="py-4 pe-4">
                                            ...
                                            <p class="text-muted small mt-2 mb-0 d-flex align-items-center">
                                                <i class="bi bi-info-circle me-2"></i>
                                                Changing primary email is not allowed.
                                            </p>
        ...
        <div class="card shadow-sm border mt-4">
            <div class="card-body">
                ...
                <div class="d-flex flex-column flex-md-row gap-2 justify-content-end">
                    ...
                    <a href="{{ route('profile.edit') }}" class="btn btn-outline-secondary px-4 shadow-sm">
                        Reset Changes
                    </a>
