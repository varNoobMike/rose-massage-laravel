    ...
    <form action="{{ route('announcements.store') }}" method="POST" enctype="multipart/form-data" novalidate>
        ...
        <div class="row g-4">
                        ...
                        <table class="table table-borderless mb-0 align-middle">
                            <tbody>
                                ...
                                <tr class="border-bottom border-light">
                                    ...
                                    <td class="py-4 pe-4">
                                        <input type="text" name="title"
                                            ...
                                            value="{{ old('title') }}" placeholder="e.g. Holiday Schedule Notice">
                                ...
                                <tr class="border-bottom border-light">
                                    ...
                                    <td class="py-4 pe-4">
                                        <textarea name="message" rows="5" class="form-control border-2 @error('message') is-invalid @enderror"
                                ...
                                <tr class="border-bottom border-light">
                                    ...
                                    <td class="py-4 pe-4">
                                        <select name="type"
                                            ...
                                            <option value="" @selected(blank(old('type')))>
                                                -- Select Type --
                                            </option>
                                            <option value="promo" @selected(old('type') === 'promo')>
                                                Promo
                                            </option>
                                            <option value="update" @selected(old('type') === 'update')>
                                                Update
                                            </option>
                                            <option value="alert" @selected(old('type') === 'alert')>
                                                Alert
                                            </option>
                                ...
                                <tr class="border-bottom border-light">
                                    ...
                                    <td class="py-4 pe-4">
                                        <select name="link_page"
                                            ...
                                            <option value="" @selected(blank(old('link_page')))>-- Select
                                                --</option>
                                            <option value="bookings" @selected(old('link_page') == 'bookings')>
                                                Bookings</option>
                                            <option value="services" @selected(old('link_page') == 'services')>
                                                Services</option>
                                        </select>
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="card shadow-sm border d-none">
        ...
        <div class="card shadow-sm border mt-4">
            <div class="card-body">
                ...
                <div class="d-flex flex-column flex-md-row gap-2 justify-content-end">
                    ...
                    <a href="{{ route('announcements.create') }}" class="btn btn-outline-secondary px-4 shadow-sm">
                        Reset
                    </a>
