...
@section('page-header-title-showpage', 'Edit Therapist #' . $user->id)
@section('page-header-subtitle', 'Update this therapist record')

@section('content')
    <form action="{{ route('therapists.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card shadow-sm border mt-4">
            <div class="card-body">
                ...
                <div class="d-flex flex-column flex-md-row gap-2 justify-content-end">
                    ...
                    <a href="{{ route('therapists.edit', $user->id) }}" class="btn btn-outline-secondary px-4 shadow-sm">
                        Reset Changes
                    </a>
