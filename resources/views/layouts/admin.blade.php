...
<body>
    ...
    <div class="container-fluid p-0" style="min-height: 100vh;">
        ...
        <div class="row g-0">
            ...
            <!-- Sidebar - Desktop -->
            <div id="sidebar" class="col-2 bg-white border-end d-none d-md-block min-vh-100">
                <div class="py-4 px-3">
                    <div class="mb-4 px-2">
                        <h5 class="fw-bold mb-0 text-dark" style="letter-spacing: -0.5px;">
                            ROSE MASSAGE
                        </h5>
                        <small class="text-muted text-uppercase fw-semibold" style="font-size: 0.65rem;">Control Panel</small>
                    </div>

                    <ul class="nav flex-column gap-2">
                        <li class="nav-item mb-1">
                            <a href="{{ route('dashboard') }}" 
                                class="nav-link {{ request()->is('dashboard') ? 'text-bg-primary fw-bold' : 'text-dark opacity-75' }} px-3 py-2 d-flex align-items-center">
                        ...
                        <li class="nav-item mb-1">
                            <a href="{{ route('bookings.index') }}" 
                                class="nav-link {{ request()->is('bookings*') ? 'text-bg-primary fw-bold' : 'text-dark opacity-75' }} px-3 py-2 d-flex align-items-center">
                        ...
                        <li class="nav-item mb-1">
                            <a href="{{ route('services.index') }}" 
                                class="nav-link {{ request()->is('services*') ? 'text-bg-primary fw-bold' : 'text-dark opacity-75' }} px-3 py-2 d-flex align-items-center">
                        ...
                        <li class="nav-item mb-1">
                            <a href="{{ route('users.index') }}" 
                                class="nav-link {{ request()->is('users*') ? 'text-bg-primary fw-bold' : 'text-dark opacity-75' }} px-3 py-2 d-flex align-items-center">
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="sidebarOffcanvas" aria-labelledby="sidebarOffcanvasLabel">
                <div class="offcanvas-header border-bottom">
                    <h5 class="offcanvas-title fw-bold" id="sidebarOffcanvasLabel">ADMIN MENU</h5>
                    <button type="button" class="btn-close shadow-none" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
                <div class="offcanvas-body p-0">
                    <ul class="nav flex-column p-3">
                        <li class="nav-item">
                            <a href="{{ route('dashboard') }}" class="nav-link text-dark py-3">
                    ...
                    <div class="container-fluid px-3 px-lg-5"> 
                        ...
                        <div class="collapse navbar-collapse" id="navbarMain">
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex align-items-center gap-3">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link fs-5 d-flex align-items-center p-1" href="{{ route('notifications.index') }}">
                                        <i class="bi bi-bell"></i>
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link fs-5 d-flex align-items-center p-1" href="{{ route('announcements.index') }}">
                                        <i class="bi bi-megaphone"></i>
                                    </a>
                                </li>

                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle d-flex align-items-center p-0 shadow-none border-0" href="#" role="button" data-bs-toggle="dropdown">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                @hasSection('breadcrumb-parent')
                                    <li class="breadcrumb-item"><a href="@yield('breadcrumb-parent-url')" class="text-decoration-none">@yield('breadcrumb-parent')</a></li>
                                @endif
