            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-3">
                    <input type="text" name="search" class="form-control"
                        placeholder="Search review author, review id..." value="{{ $filters['search'] ?? '' }}">
                </div>
                ...
                <div class="col-12 col-md-2">
                    <select name="rating" class="form-select">
                        ...
                        <option value="" @selected(empty($filters['rating']))>
                            All Ratings
                        </option>

                        <option value="5" @selected(($filters['rating'] ?? null) == '5')>
                            5 Stars
                        </option>

                        <option value="4" @selected(($filters['rating'] ?? null) == '4')>
                            4 Stars
                        </option>

                        <option value="3" @selected(($filters['rating'] ?? null) == '3')>
                            3 Stars
                        </option>

                        <option value="2" @selected(($filters['rating'] ?? null) == '2')>
                            2 Stars
                        </option>

                        <option value="1" @selected(($filters['rating'] ?? null) == '1')>
                            1 Star
                        </option>
